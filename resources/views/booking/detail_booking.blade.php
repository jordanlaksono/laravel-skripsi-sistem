...
<script>
var tgl_1 = $('#tgl_1').val();
var id_booking = '{{ Request::segment(3) }}';
...
function orde_tgl(tgl){
    $('#loading').modal('show');
    var booking = '';
    $.getJSON('/bookings/load_booking_all/'+tgl+'/'+id_booking, {
		format: "json"
	})
    .done(function (data) {
        $('#loading').modal('hide');
           ...
           // var dateformat = dateformat(now, 'dddd, mmmm dS, yyyy, h:MM:ss TT')
            booking += `
                    ...
                    ">
                        ...
                        <div class="bookingStatus"></div>
                        <div class="bookingOptions">
                            <div class="bookingActions">
                                <div>
                                    <a href="/bookings/bookingsDetail/${val.fc_kddetbooking}" class="btn btn-success" >Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
