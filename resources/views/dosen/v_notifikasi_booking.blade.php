...
@section('title','Notifikasi Booking')
        ...
        <form class="form-horizontal">
            <div style="flex: 1; display: flex; flex-direction: column;">
              ...
              <div class="form-group" style="display: flex;">
                <label for="inputEmail3" class="col-sm-3 control-label" >Lompat Ke Tanggal </label>
                <div class="col-sm-6">
...
<script>
    ...
    function orde_tgl(tgl){
        $('#loading').modal('show');
        var booking = '';
        $.getJSON('/dosen/load_booking_all/'+tgl+'/'+kode_user, {
            format: "json"
        })
        .done(function (data) {
            $('#loading').modal('hide');
               ...
               // var dateformat = dateformat(now, 'dddd, mmmm dS, yyyy, h:MM:ss TT')
                ...
                booking += `
                        <div class="bookingItem booking_accepted booking_past showMeta showProfile">
                            <div class="bookingProfile">
                                <span class="bookingName" alt="edwinlaksono12-0" title="edwinlaksono12-0">
                                    <span class="bookingItemData">Urgensi: </span>
                            ...
                            <div class="bookingDate">
                                <div>
                                    ...
                                    <br><span class="bookingItemMeta"><span>Durasi:</span> ${val.fc_duration}</span>
                                </div>
                            </div>
                        ...
                        ">
                                ...
                                <span class="bookingItemMeta">Dibuat Pada <span class="serverDate">${tgl_book}</span></span>
                            </div>
                            <div class="bookingMeta"></div>
                            <div class="bookingStatus"><a href="/dosen/bookingsDetail/${val.fc_kdbooking}" class="btn btn-primary" >Detail</a></div>
